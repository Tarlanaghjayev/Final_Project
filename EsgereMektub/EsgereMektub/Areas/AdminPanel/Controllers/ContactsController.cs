...
namespace EsgereMektub.Areas.AdminPanel.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Mail,Phone,Text")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Mail,Phone,Text")] Contact contact)
        {
            if (ModelState.IsValid)
            {
